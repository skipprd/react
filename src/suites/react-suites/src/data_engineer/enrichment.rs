...
impl DataEngineerSuite {
    ...
    pub(super) fn is_placeholder_cleanse_spec(spec: Option<&crate::data_engineer::plan::CleanseImplementationSpec>) -> bool {
        spec.is_none()
    }

    pub(super) fn is_placeholder_model_spec(spec: Option<&crate::data_engineer::plan::ModelImplementationSpec>) -> bool {
        spec.is_none()
    }
    ...
    pub(super) fn critique_guidance(critique: &crate::data_engineer::plan_schema::PlanDesignCritiqueV1) -> String {
        ...
        let tasks: Vec<crate::data_engineer::plan::ModelTask> = task_names
            ...
            .map(|name| {
                crate::data_engineer::plan::ModelTask {
                    name,
                    folder: crate::data_engineer::plan::ModelFolder::default(),
                    goal: String::new(),
                    inputs: vec![],
                    expected_model_path: None,
                    invariants: vec![],
