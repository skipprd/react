...
mod tests {
    use super::*;
    use crate::data_engineer::project_fs::join_storage_key;
    use crate::data_engineer::project_fs::test_helpers::*;
...
"#;
    ...
    async fn apply_patch_schema_yml_rebuilds_sources_and_preserves_models() {
        ...
        *q.schemas.lock().unwrap() = std::collections::HashMap::from([
        ...
        let datasets: Arc<dyn crate::data_engineer::providers::DatasetCatalogProvider> =
